										...
										<div class="gdpr-sortable-button" data-type="close">
											<table>
												<tbody>
													...
													<tr>
														<td colspan="2"><p class="description" id="moove_gdpr_close_button_enable-description" ><?php esc_html_e( "Close Button allows users to hide the Cookie Banner for the duration of the current browsing session. Cookies will not be accepted or rejected and the Cookie Banner will re-appear again for the user when they next visit your site.", 'gdpr-cookie-compliance' ); ?></p>
															<!--  .description --></td>
													</tr>
												</tbody>
											</table>
