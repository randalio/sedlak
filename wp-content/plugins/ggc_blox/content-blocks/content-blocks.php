...
if(have_rows('row_type_'.$block_page, $page_id)){
  while ( have_rows('row_type_'.$block_page, $page_id) ) : the_row();
    ...
    if( get_row_layout() == 'two_column_layout_'.$block_page2 ): ?>
        ...
        if(have_rows('content_blocks_two_col_row_settings_'.$block_page2) ):
          while ( have_rows('content_blocks_two_col_row_settings_'.$block_page2, $page_id) ) : the_row();
            ...
            $main_bg = get_sub_field('content_blocks_two_col_row_main_bg_group');
            $main_bg_color = $main_bg['content_blocks_two_col_row_main_bg_color'];
            $main_bg_image = $main_bg['content_blocks_two_col_row_main_bg_image'];
    ...
    <div class="container-fluid px-0"  style="<?php if($main_bg_color != ''): ?> background-color: <?php echo $main_bg_color; ?>;<?php endif; ?><?php if($main_bg_image != ''): ?> background-image: url(<?php echo $main_bg_image['url']; ?>);<?php endif; ?>"   >
      <div class="<?php echo $row_2col_container.' '.$row_layout; ?> <?php echo $row_2col_class; ?> two-columns anchor" <?php if($row_2col_ID != ''): ?>id="<?php echo $row_2col_ID; ?>"<?php endif; ?>>
        <div class="row">

          <div class="col col-12 <?php if($row_layout == 'even_split'): ?>col-md-6<?php endif; ?><?php if( $row_layout  == 'sidebar_l' ): ?>col-md-5 col-lg-4 order-last order-md-first pr-5<?php endif; ?><?php if( $row_layout  == 'sidebar_r' ): ?>col-md-7 col-lg-8 order-first pr-sm-0 pr-lg-5<?php endif; ?>" <?php if( $left_bg_color != ''): ?>style="background-color: <?php echo $left_bg_color; ?>"<?php endif;?>>
          ...
          <div class="col col-12 <?php if($row_layout == 'even_split'): ?>col-md-6<?php endif; ?><?php if( $row_layout  == 'sidebar_l' ): ?>col-md-7 col-lg-8 order-first px-4 pl-5<?php endif; ?><?php if( $row_layout  == 'sidebar_r' ): ?>col-md-5 col-lg-4 order-last px-md-4<?php endif; ?>" <?php if( $right_bg_color != ''): ?>style="background-color: <?php echo $right_bg_color; ?>"<?php endif;?>>
