...
if (!class_exists("Classes\Mail_Integration_365\Admin")) {
    class Admin
    {
        ...
        {
            $section_description = function ($args) {
            ...
            foreach (self::$settings as $key1 => $value1) {
        ...
        public function create_options_page()
        {
            ...
            if (current_user_can("install_plugins")) {
                ...
                wp_die(__("User is not authorised to access this page.", Core::$text_domain));
            }
        }
