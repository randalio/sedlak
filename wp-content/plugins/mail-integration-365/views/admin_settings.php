...
<div class="wrap">
	...
	<?php
        ...
        <h3>As of version 1.8.3, users will need to re-authorise the plugin with their Office 365 Account due to changes to how the refresh token is stored in the database</h3>
        <h2>Donations</h2>
